...
export function registerIndexerRoutes(app: Express): void {
  ...
  app.post('/api/v1/indexer/index', authMiddleware, checkPermission('document:edit'), async (req: Request, res: Response) => {
  ...
  app.post('/api/v1/indexer/yjs', authMiddleware, checkPermission('document:edit'), async (req: Request, res: Response) => {
    const startTime = Date.now();
  ...
  app.delete('/api/v1/indexer/document/:documentId', authMiddleware, checkPermission('document:edit', 'document'), async (req: Request, res: Response) => {
    try {
  ...
  app.post('/api/v1/indexer/workspace/:workspaceId/reindex', authMiddleware, checkPermission('document:edit'), async (req: Request, res: Response) => {
    const startTime = Date.now();
  ...
  // Get indexing status
  app.get('/api/v1/indexer/status', authMiddleware, async (req: Request, res: Response) => {
    try {
