          ...
          >
            ...
            <div className="flex-1 overflow-hidden relative">
              <AnimatePresence mode="wait">
                ...
                >
                  {tab === 'chat'   && workspaceId && <GraphRAGChat workspaceId={workspaceId} activeDoc={activeDoc} initialPrompt={initialPrompt} />}
                  {tab === 'search' && workspaceId && <SearchPanel  workspaceId={workspaceId} onNavigateDoc={onNavigateDoc} />}
                  {tab === 'agent'  && workspaceId && <AgentPanel   workspaceId={workspaceId} activeDoc={activeDoc} initialPrompt={initialPrompt} />}
