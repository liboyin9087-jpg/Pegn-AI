      ...
      case 'COMPLETED':
        return (
          <div className="py-3 flex gap-3">
            ...
            <button onClick={onShare} className="w-[44px] flex items-center justify-center bg-agent-bg-3 border border-agent-border-default hover:bg-agent-bg-4 text-agent-text-primary rounded-lg transition-colors active:scale-[0.98]" aria-label="Share Output">
              <Share size={18} />
            </button>
          </div>
        );
