      ...
      >
        {renamingId === node.id ? (
          ...
          <button
            ...
            className={`sidebar-item w-full flex items-center gap-1 text-left ${isActive ? 'is-active' : ''}`}
            style={{
          ...
          >
            ...
            <span
              className="sidebar-item__title flex-1 truncate"
              style={{
                fontSize: 13,
            ...
            {collections.map(col => {
              ...
              return (
                <button
                  ...
                  className={`sidebar-item w-full flex items-center gap-2 text-left py-1.5 px-3 mb-0.5 ${isActive ? 'is-active' : ''}`}
                >
