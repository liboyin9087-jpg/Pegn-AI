# AGENTS.md — Pegn-AI Project Context Cache

> 此檔案供 Codex 使用，讓每次新 session 快速掌握專案狀態，無需重新讀取所有檔案。

## 當前狀態

- **Branch**: `Codex/review-core-features-M27dd`
- **Phase**: Phase 3 P0 + P1 實作完成
- **最後工作**: P1 全部完成，TypeScript 零錯誤
...
| `/api/v1/agents` | `routes/agent.ts` | Agent 執行 + quota |
...
| `/api/v1/webhooks` | `routes/webhook.ts` | Webhook 管理 |
...
```bash
# 當前功能分支
git checkout Codex/review-core-features-M27dd
...
# 推送
git push -u origin Codex/review-core-features-M27dd
```
